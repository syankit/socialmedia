...
import 'package:health_app/screen/comment_screen.dart';
import 'package:health_app/util/colors.dart';
import 'package:health_app/util/utils.dart';
import 'package:health_app/models/user.dart' as model;
import 'package:health_app/widget/like_animations.dart';
        ...
        children: [
          ...
          Container(
            padding: const EdgeInsets.symmetric(
              vertical: 4,
              horizontal: 16,
            ).copyWith(right: 0), //copywith add extra padding from right
            child: Row(
              children: <Widget>[
                CircleAvatar(
                  radius: 16,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: RichText(
                    //allow us to have multiple text
                    text: TextSpan(
